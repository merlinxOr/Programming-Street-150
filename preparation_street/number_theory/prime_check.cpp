...
int main()
{
    cout << (is_prime(7) ? "Is prime" : "Not prime") << endl;
    cout << (is_prime(4) ? "Is prime" : "Not prime") << endl;
    cout << (is_prime(2) ? "Is prime" : "Not prime") << endl;
    cout << (is_prime(1) ? "Is prime" : "Not prime") << endl;
    cout << (is_prime(29) ? "Is prime" : "Not prime") << endl;
    return 0;
}
